...
print('Done reading...')
#print('Exporting...')
#template.to_excel(fileRead + " Result Raw 0101.xlsx", index=False) 
...
#df.to_excel(fileRead + ' Mistake Notes 0101.xlsx', 'Sheet1', index=False)
...
#data = pd.read_excel(fileRead + ' Result Raw 0101.xlsx', na_filter=False)
...
print('Exporting...')
#duplicate.to_excel(fileRead + " Result Final 0101.xlsx", index=False)
